...
var Mandrill = require('node-mandrill')('85lzzANtRJ46i_mLLRjHoQ');
...
internals.validStatusIds = ["status_germinate", "status_root", "status_alive", "status_inactive", "status_pending", "status_rejected"];
            ...
            .then(function(createdData){
                ...
                var message = {
                    to: [
                        ...
                        {email: "pmagarrett@gmail.com"},
                        {email: "david.a.avelar@gmail.com"},
                        //{email: "moderadores@redeconvergir.net"},
                        {email: initiativeEmail}
                    ],
                    from_email: "info@redeconvergir.net",
                    subject: "RedeConvergir - " + projectName,
                    text: "O  projecto " + projectName + " encontra-se pendente para moderação na RedeConvergir."
                };
