...
internals.mandrillClient = new Mandrill("85lzzANtRJ46i_mLLRjHoQ");
...
internals.validation.type = ["type_001_permaculture", "type_002_transition", "type_003_soil_nature", "type_004_construction", "type_005_tools", "type_006_culture", "type_007_health", "type_008_economy", "type_009_community", "type_999_other"];

internals.validation.domains = ["domain_001_agriculture", "domain_002_husbandry", "domain_003_bioconstruction", "domain_004_ecotechnology", "domain_005_art", "domain_006_education", "domain_007_health", "domain_008_spirituality", "domain_009_economy", "domain_010_sharing", "domain_011_tools", "domain_999_other"];

internals.validation.target = ["target_001_children", "target_002_teenagers", "target_003_adults", "target_004_seniors", "target_005_families", "target_006_handicapped", "target_007_special_need_children", "target_008_general", "target_999_other"];

internals.validation.visitors = ["visitors_001_yes", "visitors_002_no", "visitors_003_confirmation"];

internals.validation.scope = ["scope_001_urban", "scope_002_rural", "scope_003_mixed"];

internals.validation.initiativeStatus = ["initiative_status_001_germinate", "initiative_status_002_root", "initiative_status_003_alive", "initiative_status_004_inactive"];

internals.validation.moderationStatus = ["moderation_status_001_pending", "moderation_status_002_approved", "moderation_status_003_rejected"];
    ...
    handler: function(request, reply) {
        ...
        Seneca.actAsync({
            ...
            .then(function(createdData){
                ...
                // TODO: send the email also to the personxxx
