...
exports.configureNunjucks = function(){
    ...
    Nunjucks.addFilter('stringify', function(obj) {

        return JSON.stringify(obj);
    });

    Nunjucks.addFilter('getDomainLogo', function(array, elem) {
    ...
    Nunjucks.addFilter('getDefinitionClass', function(array, elem) {
    ...
    Nunjucks.addFilter('parseNewLines', function(text) {
    ...
    Nunjucks.addFilter('toFixed', function(num, precision) {
