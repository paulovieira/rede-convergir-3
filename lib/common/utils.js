...
exports.configureNunjucks2 = function(server){
    ...
    var env = Nunjucks.configure(Config.get("hapi.viewsDir"), { 
        autoescape: false,
        watch: false, 
        trimBlocks: true,
    });
...
// internals.nunjucks.addFilters = function(env){
...
// internals.nunjucks.addGlobals = function(env){
