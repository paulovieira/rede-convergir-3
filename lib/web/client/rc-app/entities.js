...
// initial selection of types (hardcoded at the beggining of this file; should be empty)
...
// console.log("updateInVisibleBounds")
        ...
        for(var i=0, l=this.models.length; i<l; i++){
            ...
            point = leafletMap.latLngToContainerPoint(
    ...
    _updateInFilters: function(options){
        ...
        var refresh = true, selectedTypes = [];
        ...
        for(i=0, l=this.models.length; i<l; i++){
            ...
            model.attributes.inFilters = hasType && hasDomain;
        }
...
var MapM = Backbone.Model.extend({
    ...
    initializeMap: function(options){
        ...
        // we have an instance of L.GeoJson in the map model, but it is not added to the map yet
        var leafletMap = this.get("leafletMap"),
