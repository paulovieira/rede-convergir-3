...
console.log(feature.properties.name)
        ...
        if(feature.properties.circleMarker){
            marker = L.circleMarker(feature.properties.coordinates, {
                radius: 1
            });            
        }
        else{
            marker = L.marker(feature.properties.coordinates, {
        ...
        marker.on("mouseover", function(e){
            ...
            target.style["transform-origin"] = "center bottom";
            target.style["transform"] = target.style["transform"] + " scale(1.2)";
        });
...
//debugger;
            ...
            var i = target.style["transform"].indexOf("scale(1.2)");
            if(i>=0){
                ...
                target.style["transform"] = target.style["transform"].substring(0, i);
            }
        });
...
// console.log(array[i]["circleMarker"]);
            ...
            array[i]["geoJson"] = {
                ...
                properties: {
                        ...
                        // remove later
                        circleMarker: array[i]["circleMarker"] || false
