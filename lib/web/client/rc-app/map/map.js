...
var MapIV = Mn.ItemView.extend({
    ...
    initializeMap: function(){
        ...
        // add the default base map to the leaflet map
        var defaultBaseLayerM = this.model.get("baseLayersC").findWhere({ active: true});
        cartografiaChannel.request("selectLayer", defaultBaseLayerM.get("id"));
