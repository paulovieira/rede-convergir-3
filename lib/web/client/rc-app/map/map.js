...
*/
        ...
        // var cityNamesLayer = L.tileLayer("http://{s}.base.maps.cit.api.here.com/maptile/2.1/labeltile/newest/normal.day/10/490/392/256/png?app_id=Y8m9dK2brESDPGJPdrvs&app_code=dq2MYIvjAotR8tHvY8Q_Dg&lg=eng", {
        //             subdomains: "1234",
        //             zIndex: 10
        //         });

        var cityNamesLayer = L.tileLayer('http://{s}.tile.openstreetmap.se/hydda/roads_and_labels/{z}/{x}/{y}.png', {
        });

        // var cityNamesLayer = L.tileLayer('http://otile{s}.mqcdn.com/tiles/1.0.0/hyb/{z}/{x}/{y}.png', {
        //     subdomains: '1234',
        // });

        this.map.addLayer(cityNamesLayer);
/*        
...
//debugger;        
        ...
        options = options || {};
        if(options.fitBounds && !_.isEmpty(_layers)){
