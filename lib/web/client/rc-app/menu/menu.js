...
var MenuBodyLV = Mn.LayoutView.extend({
    ...
    onAttach: function(){
        ...
        this.$("input#search-initiative").val(RC.searchText).focus();
    },
    ...
    removeArrow: function(e){
        ...
        if(y>0){
            document.styleSheets[11].addRule('.arrow','display: none;');
        }
        else{
            document.styleSheets[11].addRule('.arrow','display: block;');   
        }
...
//     },
    ...
    show: function(){
        ...
        var menuBodyIV = new MenuBodyLV({
            model: new Backbone.Model(RCData.definitions)
        });
