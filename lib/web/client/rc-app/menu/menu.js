...
var MenuListIV = Mn.ItemView.extend({
    ...
    onAttach: function(){
        ...
        cartografiaChannel.request("updateScrollbar");
...
var MenuBodyLV = Mn.LayoutView.extend({
    ...
    initialize: function(){
        ...
        // $(window).on("resize", _.bind(this.getElementPosition, this));
    },

    template: "menu/templates/menu-body.html",

    attributes: {
        style: "height: 100%;  position: relative; padding-top: 5px; xoverflow-y: auto;"
    },
    ...
    onAttach: function(){
        ...
        cartografiaChannel.reply("updateScrollbar", function(){
        ...
        //     // update the scrollbar plugin (necessary to make sure the scroll actually is visivle on mouseover)
