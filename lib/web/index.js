...
internals.typesIds = ["type_permaculture", "type_transition", "type_soil_nature", "type_construction", "type_tools", "type_culture", "type_health", "type_economy", "type_community", "type_other"];

internals.domainsIds = ["domain_agriculture", "domain_husbandry", "domain_bioconstruction", "domain_ecotechnology", "domain_art", "domain_education", "domain_health", "domain_spirituality", "domain_economy", "domain_sharing", "domain_tools"];

internals.baseLayersIds = ["stamen", "esri_satellite", "mapquest"];
        ...
        config: {
            ...
            validate: {
                ...
                query: {
                    ...
                    baseLayer: Joi.string().insensitive().valid(internals.baseLayersIds).default("stamen"),
                    types: Joi.array().items( Joi.string().valid(internals.typesIds) ).single(),
                    domains: Joi.array().items( Joi.string().valid(internals.domainsIds) ).single()
                }
            },

            pre: [
                [Pre.readInitiativesSlim, Pre.readDefinitions]
            ]
        },
